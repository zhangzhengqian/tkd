        ...
        <div class="panel-body"><!-- 右侧主体内容 -->
	        ...
	        <c:forEach items="${spaces}" var="space" varStatus="stat">
	            ...
	            <div class="form-group">
	                <div class="<c:if test="${action!='detail' }">col-md-offset-3</c:if> <c:if test="${action=='detail' }">col-md-offset-4</c:if> col-md-2">
	                    <a class="btn btn-default btn-block" href="${ctx}/statium/space?statiumId=${statiumId}"><span class="glyphicon glyphicon-remove"></span> 返回</a>
	                </div>
