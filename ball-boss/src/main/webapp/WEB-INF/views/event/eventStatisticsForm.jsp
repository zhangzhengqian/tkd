...
<div class="panel panel-default">
  ...
  <div class="panel-body"><!-- 右侧主体内容 -->
  	<fieldset> <legend><small>赛事统计</small></legend>
	<form id="inputForm" action="${ctx}/event/updateEventStatistics" method="post" class="form-horizontal">
		...
		<fieldset>
			<div class="form-group form-group-sm">
			    ...
			    <div class="col-md-6 has-feedback">
			    	<input placeholder="请输入运营成本" type="text" class="form-control" id="costPrice" name="costPrice" value="${event.costPrice}"/>
			    </div>
			</div>
			...
			<div class="form-group form-group-sm">
			    ...
			    <div class="col-md-6 has-feedback">
			    	<input placeholder="请输入场地支出" type="text" class="form-control" id="expenditure" name="expenditure" value="${event.expenditure}"/>
			    </div>
			</div>
			...
			<div class="form-group form-group-sm">
			    ...
			    <div class="col-md-6 has-feedback">
			    	<input placeholder="请输入盈利" type="text" class="form-control" id="profit" name="profit" value="${event.profit}"/>
			    </div>
			</div>
			...
			<div class="form-group form-group-sm">
			    ...
			    <div class="col-md-6 has-feedback">
			    	<textarea rows="5" cols="105" id="remark" placeholder="请输入备注信息" name="remark">${event.remark}</textarea>
			    </div>
			</div>
      	  ...
      	  <div class="form-group form-group-sm">
				...
				<div class="col-md-2">
					<a class="btn btn-default btn-block" href="${ctx}/event/statisticsList"><span class="glyphicon glyphicon-remove"></span> 返回</a>			  
				</div>
		  </div>			 		 					
		</fieldset>
	</form>
