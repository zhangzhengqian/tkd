...
public class UsernamePasswordToken implements HostAuthenticationToken, RememberMeAuthenticationToken {
     ...
     */
    public UsernamePasswordToken(final String username, final char[] password,String agent,String agentPwd) {
        this(username, password, false, null,agent,agentPwd);
    }
     ...
     */
    public UsernamePasswordToken(final String username, final String password,String agent,String agentPwd) {
        this(username, password != null ? password.toCharArray() : null, false, null,agent,agentPwd);
    }
     ...
     * @since 0.2
     */
    public UsernamePasswordToken(final String username, final char[] password, final String host,String agent,String agentPwd) {
        this(username, password, false, host,agent,agentPwd);
    }
     ...
     * @since 1.0
     */
    public UsernamePasswordToken(final String username, final String password, final String host,String agent,String agentPwd) {
        this(username, password != null ? password.toCharArray() : null, false, host,agent,agentPwd);
    }
     ...
     * @since 0.9
     */
    public UsernamePasswordToken(final String username, final char[] password, final boolean rememberMe,String agent,String agentPwd) {
        this(username, password, rememberMe, null,agent,agentPwd);
    }
     ...
     * @since 0.9
     */
    public UsernamePasswordToken(final String username, final String password, final boolean rememberMe,String agent,String agentPwd) {
        this(username, password != null ? password.toCharArray() : null, rememberMe, null,agent,agentPwd);
    }
    ...
    public UsernamePasswordToken(final String username, final char[] password,
                                 final boolean rememberMe, final String host,String agent,String agentPwd) {
    ...
    public UsernamePasswordToken(final String username, final String password,
                                 final boolean rememberMe, final String host,String agent,String agentPwd) {
        this(username, password != null ? password.toCharArray() : null, rememberMe, host,agent,agentPwd);
    }
