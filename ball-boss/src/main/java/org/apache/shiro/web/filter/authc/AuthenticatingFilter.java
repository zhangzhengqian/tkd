...
public abstract class AuthenticatingFilter extends AuthenticationFilter {
    ...
    protected AuthenticationToken createToken(String username, String password,
                                              ServletRequest request, ServletResponse response,String agent,String agentPwd) {
        boolean rememberMe = isRememberMe(request);
        String host = getHost(request);
        return createToken(username, password, rememberMe, host,agent,agentPwd);
    }

    protected AuthenticationToken createToken(String username, String password,
                                              boolean rememberMe, String host,String agent,String agentPwd) {
        return new UsernamePasswordToken(username, password, rememberMe, host,agent,agentPwd);
    }
