  ...
  <div class="panel-body"><!-- 右侧主体内容 -->				
	<div class="row">
    	<div class="col-table col-md-12" >
	    	<form class="form-horizontal" id="orderVoForm" action="${ctx }/statisticRegisterUser/statisticChannelOrders">
				...
				<tbody>
					<c:forEach items="${data.content }" var="record" varStatus="stat">
						<tr>
							...
							<td style="text-align: center;">${record.channel }</td>
							<td style="text-align: center;">${record.num }</td>
						</tr>
					</c:forEach>
				</tbody>		
			</table>
...
$(function() {
	menu.active('#statisticOrders-channelOrders');
