...
public class FormAuthenticationFilter extends AuthenticatingFilter {
    ...
    public static final String DEFAULT_AGENT_PARAM = "agent";
    public static final String DEFAULT_AGENTPWD_PARAM = "agentPwd";
    ...
    private String agentParam = DEFAULT_AGENT_PARAM;
    private String agentPwdParam = DEFAULT_AGENTPWD_PARAM;
	...
	public String getAgentPwdParam() {
		return agentPwdParam;
	}

	public void setAgentPwdParam(String agentPwdParam) {
		this.agentPwdParam = agentPwdParam;
	}
    ...
    protected AuthenticationToken createToken(ServletRequest request, ServletResponse response) {
        ...
        String agent = getAgentParam(request);
        String agentPwd = getAgentPwdParam(request);
        return createToken(username, password, request, response,agent,agentPwd);
    }
    ...
    protected String getAgentParam(ServletRequest request) {
        return WebUtils.getCleanParam(request, getAgentParam());
    }

    protected String getAgentPwdParam(ServletRequest request) {
        return WebUtils.getCleanParam(request, getAgentPwdParam());
    }
