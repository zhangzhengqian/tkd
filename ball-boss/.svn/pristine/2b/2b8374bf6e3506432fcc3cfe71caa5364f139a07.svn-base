...
<div class="panel panel-default">
  ...
  <c:if test="${param.action == 'edit' }">
	<fieldset> <legend><small>用户信息修改</small></legend>
  </c:if>
	<form id="inputForm" action="${ctx}/ssouser/updateSsoUser" method="post" class="form-horizontal" enctype="multipart/form-data">
		...
		<fieldset>
			...
			<div class="form-group form-group-sm">
                ...
                <div class="col-sm-4">
                     <div class="input-group col-md-6 has-feedback">
                         <input value="${birth }" type="text" name="bDate" id="bDate" class="form-control" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" readonly>
			...
			<div class="form-group form-group-sm">
				<label for="sort" class="col-md-3 control-label"><span class="text-red"></span>账户状态：</label>
			    <div class="col-md-6 has-feedback"> 
	  			 <input type="text" class="form-control" style="width:480px" value="${data.state }" readonly />
			    </div>
			</div>
			<div class="form-group form-group-sm">
			...
			<div class="form-group form-group-sm">
				<label for="sort" class="col-md-3 control-label"><span class="text-red"></span>账户中奖金金额:</label>
				<div class="col-md-6 has-feedback">
					<input type="text" class="form-control" style="width:480px" value="${data.bonus }元" readonly />
				</div>
			</div>
			<div class="form-group form-group-sm">
				<label for="sort" class="col-md-3 control-label"><span class="text-red"></span>冻结金额:</label>
			    <div class="col-md-6 has-feedback"> 
	  			 <input type="text" class="form-control" style="width:480px" value="${data.freez }元" readonly />
			    </div>
			</div>
		<div class="row">
		<div class="col-md-1">
	    	...
	    	<div class="col-table col-md-8" >		
			    ...
			    <div class="col-md-6 has-feedback">
			    	<input type="text" class="form-control" style="width:480px" value="${qiuyouAmount }" readonly />
			    </div>
			</div>
			<div class="form-group form-group-sm">
				<label for="sort" class="col-md-3 control-label"><span class="text-red"></span>剩余积分:</label>
			    <div class="col-md-6 has-feedback">
			    	<input type="text" class="form-control" style="width:480px" value="${integralAccount }" readonly />
		    	...
		    	<c:if test="${readonly!=' '}">
					...
					<div class="col-md-2">
						<shiro:hasPermission name="ssouser:update">
							<a href="${ctx }/ssouser/view?action=edit&id=${ssoUser.id }" class="btn btn-primary btn-block" > 修改 </a>
						</shiro:hasPermission>
					</div>
		    	</c:if>
		  </div>		
