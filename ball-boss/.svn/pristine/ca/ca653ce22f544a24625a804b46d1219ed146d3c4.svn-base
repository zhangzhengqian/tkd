package com.lc.zy.ball.boss.common.pay.wxap;
...
import com.lc.zy.ball.boss.common.pay.wxap.client.TenpayHttpClient;
import com.lc.zy.ball.boss.common.pay.wxap.util.MD5Util;
import com.lc.zy.ball.boss.common.pay.wxap.util.TenpayUtil;
...
public class RequestHandler {
	 ...
	 * 初始化函数。
	 */
	public void init(String app_id, String app_secret, String key) {
		this.last_errcode = "0";
		this.Token = "token_";
		this.debugInfo = "";
		this.appid = app_id;
