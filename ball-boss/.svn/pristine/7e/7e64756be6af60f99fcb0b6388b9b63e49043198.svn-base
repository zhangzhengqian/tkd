...
import com.lc.zy.ball.boss.common.service.AbstractProvider;
import com.lc.zy.ball.boss.common.service.Providers;
...
public class FunctionProvider extends AbstractProvider {
	...
	protected void load() {
		...
		List<Function> funcs = functionMapper.selectByExample(null);
