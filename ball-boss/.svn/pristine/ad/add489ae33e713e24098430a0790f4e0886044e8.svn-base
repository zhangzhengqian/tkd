...
<form id="form1" action="${ctx}/admin/org/save" method="post" class="form-horizontal">
	...
	<fieldset>
		...
		<div class="form-group form-group-sm">
			<label for="seq" class="col-md-3 control-label"><span class="text-red"> </span>合作者身份ID:</label>
			<div class="col-md-6 has-feedback">
		...
		<div class="form-group form-group-sm">
			<label for="seq" class="col-md-3 control-label"><span class="text-red"> </span>卖家支付宝账号:</label>
			<div class="col-md-6 has-feedback">
		...
		<div class="form-group form-group-sm">
			<label for="seq" class="col-md-3 control-label"><span class="text-red"> </span>商户私钥:</label>
			<div class="col-md-6 has-feedback">
		...
		<div class="form-group form-group-sm">
			<label for="seq" class="col-md-3 control-label"><span class="text-red"> </span>公钥:</label>
			<div class="col-md-6 has-feedback">
		...
		<div class="form-group form-group-sm">
			<label for="seq" class="col-md-3 control-label"><span class="text-red"> </span>微信公众账号ID:</label>
			<div class="col-md-6 has-feedback">
		...
		<div class="form-group form-group-sm">
			<label for="seq" class="col-md-3 control-label"><span class="text-red"> </span>微信商户号:</label>
			<div class="col-md-6 has-feedback">
		...
		<div class="form-group form-group-sm">
			<label for="seq" class="col-md-3 control-label"><span class="text-red"> </span>微信密钥:</label>
			<div class="col-md-6 has-feedback">
		...
		<div class="form-group form-group-sm">
			<label for="seq" class="col-md-3 control-label"><span class="text-red"> </span>微信应用id密钥:</label>
			<div class="col-md-6 has-feedback">
		...
		<div class="form-group form-group-sm">
			<label for="seq" class="col-md-3 control-label"><span class="text-red"> </span>微信公用key:</label>
			<div class="col-md-6 has-feedback">
