...
<select class="<%=clazz %> zone_coll_1${tagskey}" <c:if test="${disabled }">disabled</c:if> id="zone_province"></select>
<select class="<%=clazz %> zone_coll_2${tagskey}" <c:if test="${disabled }">disabled</c:if> id="zone_city"></select>
<select class="<%=clazz %> zone_coll_3${tagskey}" <c:if test="${disabled }">disabled</c:if> id="zone_area"></select>
