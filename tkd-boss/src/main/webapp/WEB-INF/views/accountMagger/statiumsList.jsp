			...
			<div class="row">
				...
				<div class="col-md-12">
					<form id="search_form" class="form-horizontal"
						action="${ctx}/statiums" method="post">
						...
						<tbody>
							<c:forEach items="${data.content}" var="statium" varStatus="stat">
								...
								<tr class="${status_class }">
									...
									<td><a href="${ctx }/statiums/detailForm?id=${statium.id}&page=${page}&pageSize=${pageSize}">
											${statium.dgName}</a>
									</td>
									...
									<a class="btn btn-default btn-sm" href="${ctx }/statiums/createUserForm?statiumId=${statium.dgId}"><i
									class="glyphicon glyphicon-cog"></i> 学员管理</a>
									</shiro:hasPermission>
