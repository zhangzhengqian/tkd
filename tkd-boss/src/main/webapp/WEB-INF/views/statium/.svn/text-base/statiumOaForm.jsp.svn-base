  ...
  <div class="panel-body"><!-- 右侧主体内容 -->
	...
	<form id="inputForm" action="${ctx}/statiumOa/save" method="post" class="form-horizontal" enctype="multipart/form-data">
		...
		<fieldset>
 		    ...
 		    <div class="form-group form-group-sm">
		       ...
		       <div class="col-md-6 has-feedback">
		         <input ${readonly } type="text" class="form-control" maxlength="30" id="dgName" name="dgName" value="${statium.dgName }" placeholder="请输入道馆名称" />
		       </div>
		    </div>
	    ...
	    <div class="form-group form-group-sm">
	         ...
	         <div class="col-md-6 has-feedback ">
	           <input ${readonly } type="text" class="form-control" id="address" name="address" maxlength="199" value="${statium.address}" />
	         </div>
	    </div>
	    ...
	    <div class="form-group form-group-sm">
	         ...
	         <div class="col-md-6 has-feedback">
	           <input ${readonly } type="text" class="form-control" id="contact" name="contact"  maxlength="19" value="${statium.contact }" />
	         </div>
	      </div>
	      ...
	      <div class="form-group form-group-sm">
	      	 ...
	      	 <div class="col-md-6 has-feedback">
	      	 	<input ${readonly } type="text" class="form-control" id="bankAccountName" name="bankAccountName"  maxlength="31" value="${statium.bankAccountName }" placeholder=""/> 
	      	 </div>
	      </div>
	      <div class="form-group form-group-sm">
	      	 <label for="bankAccountNo" class="col-md-3 control-label"><span class="text-red"></span>开户账号:</label>
	      	 <div class="col-md-6 has-feedback">
	      	 	<input ${readonly } type="text" class="form-control" id="bankAccountNo" maxlength="31" name="bankAccountNo" value="${statium.bankAccountNo }" placeholder=""/> 
	      	 </div>
	      </div>
	      <div class="form-group form-group-sm">
	      	 <label for="masterName" class="col-md-3 control-label"><span class="text-red"></span>开户银行:</label>
	      	 <div class="col-md-6 has-feedback">
	      	 	<input ${readonly } type="text" class="form-control" id="bankAccountBranchName" maxlength="31" name="bankAccountBranchName" value="${statium.bankAccountBranchName }" placeholder=""/> 
	      	 </div>
	      </div>
		...
		<div class="form-group form-group-sm">
	         ...
	         <div class="col-md-6 has-feedback">
	         	<textarea  ${readonly } maxlength="1999" style="height: 100px;" class="form-control" rows="5" id="remark" placeholder="道馆介绍" name="remark">${statium.remark }</textarea>
	         </div>
	      </div>
		...
		<div class="form-group">
			<div class="col-md-offset-3 col-md-3">	
	    		<a href="${ctx }/statiumOa/returnToList?page=${page}&pageSize=${pageSize}" class="btn btn-default btn-block" > 返回 </a>
			</div>
			<c:if test="${empty readonly }">
				<div class="col-md-3">
