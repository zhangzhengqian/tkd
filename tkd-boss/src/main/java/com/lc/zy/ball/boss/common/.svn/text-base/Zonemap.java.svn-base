...
public class Zonemap {
	 ...
	 * <获取编码><功能具体实现>
	 *
	 * @create：2017年4月15日 上午11:39:21
	 * @author：ywl
	 * @param args
	 * @return
	 */
	public static List<String> getAreaCode(String args){
		List<String> list = new ArrayList<String>();
		String province = args.subSequence(0, 2)+"0000";
		list.add(province);
		if(!args.endsWith("0000")){
			String city = args.subSequence(0, 4)+"00";
			list.add(city);
		}
		if(!args.endsWith("00")){
			list.add(args);
