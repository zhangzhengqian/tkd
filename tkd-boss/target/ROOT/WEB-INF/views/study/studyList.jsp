  ...
  <div class="panel-body"><!-- 右侧主体内容 -->
		      ...
		      <form id="activityForm" class="form-horizontal" action="${ctx }/study/list" method="post">
		        <div class="form-group form-group-sm">
		         	<label class="control-label col-md-1 sr-only" for="custName"></label>
	  				<div class="col-md-5">
            			<input type="text" class="form-control input-sm" id="search_LIKE_dgName" name="search_LIKE_fileName" value="${param.search_LIKE_dgName }" placeholder="按文件名称查询">
       	  			</div>
		         </div>
	   ...
	   <div class="row"><!-- 操作按钮组 -->
		    	...
		    	<shiro:hasPermission name="activity:createForm">
					 <a class="btn btn-primary btn-sm" href="${ctx }/study/createForm" >
