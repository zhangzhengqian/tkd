		...
		<form id="inputForm" action="${ctx}/coach/save" method="post"
			...
			<fieldset>
				...
				<div class="form-group form-group-sm">
					...
					<div class="col-md-6 has-feedback">
						<input ${readonly } type="text" class="form-control" id="name" name="name" value="${coach.name }" placeholder="请输入姓名" />
					</div>
				</div>
				...
				<div class="form-group form-group-sm">
					...
					<div class="col-md-6 has-feedback">
						<input ${readonly } type="text" class="form-control" id="nick" name="nick" value="${coach.nick }" placeholder="请输入昵称" />
					</div>
				</div>
				...
				<div class="form-group form-group-sm">
					...
					<div class="col-md-6 has-feedback">
						<input ${readonly } type="text" class="form-control" id="teachyear" name="teachyear" value="${coach.teachyear}" placeholder="请输入教练的教练" />
					</div>
				</div>
