...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<fieldset>
			...
			<form id="inputForm" action="${ctx}/ssouser/ssoUserForm"
				...
				<fieldset>
					<div class="form-group form-group-sm">
						...
						<div id="title" class="col-md-1 has-feedback">
							<img id="icon_img"
								src="http://www.chfax.com/public/avatar/noavatar_middle.gif"
					...
					<div class="form-group form-group-sm">
						...
						<div class="col-md-6 has-feedback">
							<input placeholder="请输入注册昵称" type="text" class="form-control"
					...
					<div class="form-group form-group-sm">
						...
						<div class="col-md-6 has-feedback">
							<input placeholder="请输入真实姓名" type="text" class="form-control"
								id="name" name="name" style="width: 480px" />
						</div>
					</div>
					...
					<div class="form-group form-group-sm">
						...
						<div class="col-md-6 has-feedback">
							<input placeholder="请输入身份证号" type="text" class="form-control"
								id="cardId" name="cardId" style="width: 480px" />
						</div>
					</div>
					...
					<div class="form-group form-group-sm">
						...
						<div class="col-md-6 has-feedback">
							<input placeholder="请输入手机号" type="text" class="form-control"
								id="phone" name="phone" style="width: 480px" />
						</div>
					</div>
					...
					<div class="form-group form-group-sm">
						...
						<div class="col-md-6 has-feedback">
							<input placeholder="请输入电子邮箱地址" type="text" class="form-control"
								id="email" name="email" style="width: 480px" />
						</div>
					</div>
