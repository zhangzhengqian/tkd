					...
					<div class="form-group form-group-sm">
						...
						<div class="col-md-6 has-feedback">
							<input placeholder="请输入真实姓名" type="text" class="form-control"
								id="name" name="name" style="width: 480px" value="${user.name }"/>
						</div>
					</div>
					...
					<div class="form-group form-group-sm">
						...
						<div class="col-md-6 has-feedback">
							<input placeholder="请输入家庭住址" type="text" class="form-control"
								id="address" name="address" style="width: 480px" value="${user.address }"/>
						</div>
					</div>
					...
					<div class="form-group form-group-sm">
						...
						<div class="col-md-6 has-feedback">
							<input placeholder="请输入身份证号" type="text" class="form-control"
								id="cardId" name="cardId" style="width: 480px" value="${user.cardId }"/>
						</div>
					</div>
					...
					<div class="form-group form-group-sm">
						...
						<div class="col-md-6 has-feedback">
							<input placeholder="请输入电子邮箱地址" type="text" class="form-control"
								id="email" name="email" style="width: 480px" value="${user.email }"/>
						</div>
					</div>
