    ...
    <div class="orderSearch">
        ...
        <ul>
            ...
            <li class="subSearch">
                ...
                <a class="submit" href="javascript:orderSubmit('BOOK_APP')">查询</a>
                ...
                <a class="exp" href = "javascript:exportOrder()">导出</a>
            </li>
        </ul>
    </div>
</form>
...
<script type="text/javascript">
    ...
    function exportOrder(){
    	 $("#search_EQ_orderType").attr("value","BOOK_APP");
