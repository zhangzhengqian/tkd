package com.lc.zy.ball.crm.framework.system.localNews.service;
...
public class NewsService extends AbstractCacheService {
	...
	public void save(NewsVo myForm) {
		try {
			...
			news.setStatiumid(myForm.getStatiumid());
