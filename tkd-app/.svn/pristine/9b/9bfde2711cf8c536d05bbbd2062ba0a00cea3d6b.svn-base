...
import com.lc.zy.common.util.alipay.sign.RSA;
import com.lc.zy.common.util.alipay.util.AlipayCore;
...
public class AlipayNotify {
	 ...
	 * @return 验证结果
	 */
	public static boolean verify(Map<String, String> params, String aliPublicKey, String partner) {
	...
	private static boolean getSignVeryfy(Map<String, String> Params, String sign, String aliPublicKey) {
		...
		logger.debug("sParaNew: {}", sParaNew);
		// 获取待签名字符串
		String preSignStr = AlipayCore.createLinkString(sParaNew);
		logger.debug("preSignStr: {}", preSignStr);
		logger.debug("sign: {}", sign);
		logger.debug("aliPublicKey: {}", aliPublicKey);
		// 获得签名验证结果
