package com.lc.zy.common.qrCode;

/**
 * Created by sl on 2016/10/14.
 */
/**
 *
 */
...
public class BarcodeFactory {
     ...
     */
    public static byte[] encode(String statiumId, int width, int height) throws Exception{
        Hashtable<EncodeHintType, String> hints = new Hashtable<EncodeHintType, String>();
        hints.put(EncodeHintType.CHARACTER_SET, "GBK");
        BitMatrix matrix = null;
        try {
            matrix = new MultiFormatWriter().encode(statiumId,
