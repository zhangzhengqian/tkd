...
public class TopicPublisher {
	...
	private static Logger logger = LoggerFactory.getLogger(TopicPublisher.class);
	...
	private BlockingQueue<String> blockingQueue = new LinkedBlockingQueue<String>(10240);
    ...
    class Producer {
    	...
    	public void sendTo(String destination,String textMessage){
