 ...
 */
package com.lc.zy.common.zoo.lock;
...
public class WriteLock extends ProtocolSupport {
    ...
    public synchronized void unlock() throws RuntimeException {
        ...
        if (!isClosed() && id != null) {
            ...
            try {
                ZooKeeperOperation zopdel = new ZooKeeperOperation() { public boolean execute() throws KeeperException, InterruptedException {
                    	//XXX 150806 : 删除当前临时节点 和被锁的对象
                    	//System.out.println("::::> dir="+dir+" ; id="+id);
                    	if(id.startsWith(dir)){
                    		zookeeper.delete(id, -1);
                    	}else{
                    		zookeeper.delete(dir+"/"+id, -1);
                    	}
                        return Boolean.TRUE;
                    }
                };
    ...
    public synchronized boolean lock() throws KeeperException, InterruptedException {
        ...
        //ensureExists(dir, null, Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL);
    ...
    public static void main(String[] args) throws Exception {
    	...
    	final WriteLock lock = new WriteLock(zooKeeper, "/lock", null);
    	...
    	final WriteLock lock1 = new WriteLock(zooKeeper, "/lock", null);
		new Thread(new Runnable() {
			@Override
			public void run() {
				try {
