package com.lc.zy.common.zoo.config;
...
import com.lc.zy.common.zoo.ActiveKeyValueStore;
...
public class ConfigWatcher extends Config implements Watcher {
	 ...
	 * 源地址，统一用这一个即可
	 */
	private String basePath = "/config-manager";
	/**
	 * 必须填写，要连接的 server
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * -----------------------
		 * xmpp.server=http://61.51.110.55:5280/rest
		 * xmpp.domain=test.com
		 */
